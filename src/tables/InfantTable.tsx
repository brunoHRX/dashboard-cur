...
interface UnidadeData {
  unidade: string;
  fichas_inf_cr: string;
  fichas_inf_amarela: string;
  fichas_inf_verde: string;
  fichas_inf_azul: string;
  espera_inf_amarela: string;
  espera_inf_verde: string;
  espera_inf_azul: string;
  fichas_inf_fastrack: string;
}

const InfantTable: React.FC = () => {
